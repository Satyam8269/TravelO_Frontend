            ...
            <div className="key-features host-details">
                <div className="gutter-bottom-small">
                    <p className="p d-flex align-center gap">
                       <span class="apps material-icons-outlined">apps</span>Dedicated Workspace
                    </p>
                    <span className="span">
                ...
                <p className="p d-flex align-center gap">
                    <span class="apps material-icons-outlined">apps</span>Free Cancellation before 7 days of booking
                </p>
            </div>
            <div className="amenities-container">
                ...
                <div className="d-flex gap-xxl">
                    <div className="d-flex direction-column">
                        ...
                        <span className="span d-flex align-center gap">
                           <span class="apps material-icons-outlined">apps</span>Free Parking on Premises
                        </span>
                        <span className="span d-flex align-center gap">
                           <span class="apps material-icons-outlined">apps</span>Dedicated Workspace
                        </span>
                    ...
                    <div className="d-flex direction-column">
                        ...
                        <span className="span d-flex align-center gap">
                           <span class="apps material-icons-outlined">apps</span>Washing Machine
                        </span>
                        <span className="span d-flex align-center gap">
                           <span class="apps material-icons-outlined">apps</span>Patio or Balcony
                        </span>
                    </div>
                </div>
            </div>
